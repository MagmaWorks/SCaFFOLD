...
#endif
{
    ...
    public static CalcDoubleChannel CreateFromDescription(string descripiton)
    {
        return ProfileDescription.ProfileFromDescription<CalcDoubleChannel>(descripiton);
    }
