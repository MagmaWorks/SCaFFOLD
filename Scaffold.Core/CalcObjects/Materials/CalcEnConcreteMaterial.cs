...
#endif
{
    ...
    public CalcEnConcreteMaterial(EnConcreteGrade grade, MagmaWorks.Taxonomy.Standards.Eurocode.NationalAnnex nationalAnnex, string name, string symbol = "")
        : base(new EnConcreteMaterial(grade, nationalAnnex), name, symbol) { }

    public CalcEnConcreteMaterial(EnConcreteGrade grade, MagmaWorks.Taxonomy.Standards.Eurocode.NationalAnnex nationalAnnex, EnConcreteExposureClass exposureClass, Length maxAggregateSize, EnCementClass cementClass, string name, string symbol = "")
        : base(new EnConcreteMaterial(grade, nationalAnnex, exposureClass, maxAggregateSize, cementClass), name, symbol) { }

    public CalcEnConcreteMaterial(EnConcreteGrade grade, MagmaWorks.Taxonomy.Standards.Eurocode.NationalAnnex nationalAnnex, EnConcreteExposureClass exposureClass, Length maxAggregateSize, EnCementClass cementClass, Length crackWidthLimit, Length minimumCover, string name, string symbol = "")
